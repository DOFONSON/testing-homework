...
//     await browser.url(`http://localhost:3000${testItemCardLink}`);
...
//     if (testCartCountCurrent <= testCartCountPrev) {
//       throw new Error("Количество продукта при повторном добавлении в корзину не изменилось");
//     }
//   });
...
//       .$(".ProductItem-Name")
//       .getText();
//     expect(testItemCardTitle).toBe("TestItemMocked")
//   });
